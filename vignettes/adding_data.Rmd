...
Each row of data should have a unique combination of the following fields:
  `trait_name`, `dataset_id`, `observation_id`, `source_id`, `taxon_name`, `population_id`, `individual_id`, `temporal_id`, `method_context_id`, `value_type`, and `original_name`

Therefore, the dataset should be able to pivot wider and the following code should have a `1` in every cell.

```{r, eval=FALSE, echo=TRUE}
austraits$traits %>%
  select(dataset_id, trait_name, value, observation_id, source_id, taxon_name, population_id, individual_id, temporal_id, method_context_id, value_type, original_name) %>%
