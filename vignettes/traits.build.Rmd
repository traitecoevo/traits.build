...
vignette: >
  %\VignetteIndexEntry{Getting started with traits.build}
...
*Please note that the AusTraits project is released with a [Contributor Code of Conduct](http://traitecoevo.github.io/traits.build/CODE_OF_CONDUCT.html). By contributing to this project you agree to abide by its terms.
...
- You collected data on one of the traits listed in the [trait definitions table](http://traitecoevo.github.io/traits.build/articles/trait_definitions.html)
...
If you want to contribute data, please review the instructions [here on how to contribute data](http://traitecoevo.github.io/traits.build/articles/contributing_data.html).
...
If you notice a possible error in AusTraits, please [post an issue on GitHub](https://github.com/traitecoevo/traits.build/issues). If you can, please provide code illustrating the problem.
...
The first step to compile AusTraits is to download a copy of the [traits.build](https://github.com/traitecoevo/traits.build/) repository from Github. Then open the Rstudio project, or open R into the right repo directory.
...
- the [structure of the compiled AusTraits database](http://traitecoevo.github.io/traits.build/articles/database_structure.html), and
- the [structure of the raw data files](http://traitecoevo.github.io/traits.build/articles/file_structure.html),
- the [list of trait definitions](http://traitecoevo.github.io/traits.build/articles/trait_definitions.html)
