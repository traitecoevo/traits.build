...
# Build each source
Test_2022_config <- dataset_configure("data/Test_2022/metadata.yml", definitions, unit_conversions)
Test_2022_raw <- dataset_process("data/Test_2022/data.csv", Test_2022_config, schema, resource_metadata)
